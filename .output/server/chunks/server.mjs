...
const _runtimeConfig = {public:{TITLE:"指尖魔法屋-醉月思的博客",VERSION:"0.1.0",app:{baseURL:"\u002F",buildAssetsDir:"\u002F_nuxt\u002F",assetsPath:{},cdnURL:null}},private:{}};
...
const renderMiddleware = lazyHandle(() => import('./render.mjs').then((e) => e.renderMiddleware));
...
export { publicConfig as a, buildAssetsURL as b, buildAssetsDir as c, privateConfig as p, server$1 as s };
